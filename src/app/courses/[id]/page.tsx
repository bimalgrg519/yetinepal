...
export default async function CoursePage({
  ...
  return (
    <div className="max-w-3xl mx-auto pt-12 rounded-xl shadow-lg">
      <div className="flex flex-col justify-center items-center border-b border-gray-600 pb-12">
        ...
        <div className="table border-collapse mt-10">
          <div className="table-row text-center">
            <p className="font-bold table-cell border border-gray-500 px-4 py-2">
              {duration} months
            </p>
            <p className="font-bold table-cell border border-gray-500 px-4 py-2">
              {price}rs
      ...
      <div className="mt-10 space-y-10">
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-3 border-b border-gray-600 pb-1">
            Course Description
          </h2>
